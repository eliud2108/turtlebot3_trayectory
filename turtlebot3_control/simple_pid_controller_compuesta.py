...
class SimplePIDController(Node):
    def __init__(self):
        ...
        self.csv_path  = os.path.join(self.base_dir, f'compuesta_pid_run_{stamp}.csv')
    ...
    def control_loop(self):
        if not self.started:
            ...
            self.get_logger().info('Iniciando seguimiento de compuesta (PID)')

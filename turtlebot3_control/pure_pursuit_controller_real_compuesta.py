...
class PurePursuitControllerReal(Node):
    def __init__(self):
        ...
        self.get_logger().info(f'Trayectoria compuesta: Línea recta + cuarto de círculo')
    ...
    def _build_reference_path(self, wps, points_per_edge=80):
        pts = []
    ...
    def save_results(self):
        ...
        data = {
            "meta": {
                "controller": "compuesta_pure_pursuit",
                "side_m": 1.75,
                "rate_hz": 20.0,

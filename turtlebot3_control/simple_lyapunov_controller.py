...
Lyapunov controller for TurtleBot3 with CSV export of trajectories, metrics and battery.
"""
...
class SimpleLyapunovController(Node):
    def __init__(self):
        ...
        # ---- Waypoints (cuadrado 1x1 m; ajusta con param 'side_m') ----
        ...
        self.csv_path = os.path.join(self.base_dir, f'lyapunov_{stamp}.csv')

...
class PurePursuitControllerReal(Node):
    def __init__(self):
        ...
        self.csv_path = os.path.join(self.results_dir, f'recta_pure_{self.timestamp}.csv')
        
        # Waypoints de línea recta de 1.75m con interpolación
        self.waypoints = []
        start_point = [0.0, 0.0]
        end_point = [1.75, 0.0]
        
        # Interpolar puntos a lo largo de la línea recta
        num_points = 40  # Puntos para mejor seguimiento
